...
public class IabHelper
{
     ...
     */
    public void queryInventoryAsync(final boolean querySkuDetails, final List<String> moreSkus, final List<String> moreSubSkus, final QueryInventoryFinishedListener listener)
    {
